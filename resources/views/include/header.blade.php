<nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
    ...
    <a href="/">
        <div class="navbar-header py-2 px-2">
            ...
            <strong class="text-secondary">Tender</strong>
        </div>
    </a>
    ...
    <ul class="nav navbar-top-links navbar-right">
        ...
        @else
            ...
            <li>
                <a href="/profile">
                    <span class="m-r-sm text-muted welcome-message">
                        &nbsp;<strong>{{ session()->get(config('global.session_user_obj'))->firstname }}
                            {{ session()->get(config('global.session_user_obj'))->lastname }}</strong>
            ...
            <li class="">
                <a href="/account" class="text-primary">
