...
@section('content')
    <div class=" row">
        <div class="col-3 offset-9 pt-2 pb-2">
            <a class="btn-block btn btn-sm btn-secondary btn-lg float-right m-r"
                href="{{ url('/account/admin/categorries/new') }}">Создать категорию</a>
        </div>
    </div>
    <div class="row">
        <div class="col-12 ">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-default float-right m-r"
                                        href="{{ url('/account/admin/categorries/edit', $category->id) }}"><i
                                            class="fa fa-edit"></i></a>
                                    @if (count($category->tenders()->get()) === 0)
                                        <a class="btn btn-sm btn-danger float-right m-r"
                                            href="{{ url('/tender-actions/category/delete', $category->id) }}"><i
