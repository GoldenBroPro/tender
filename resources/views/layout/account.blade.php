                        ...
                        <ul class="nav metismenu" id="side-menu">
                                ...
                                <a href="{{ url('/account') }}">
                                    <center>
                                        ...
                                        @if (session()->get(config('global.session_user_obj'))->um_user_role_id === config('global.user_role_admin'))
                                            <strong class="text-white">Admin Panel</strong>
                                        @else
                                            <strong class="text-white">Мой кабинет</strong>
                                        @endif
                            ...
                            @foreach ($ar_per as $permission)
                                ...
                                <li class="{{ $url === $url_current ? 'active' : '' }}">
                                    <a href="/account/{{ $permission['url_path'] }}"><i
                                            class="fa fa-folder-o"></i><span
                                            class="nav-label">{{ $permission['tab_name'] }}</span></a>
